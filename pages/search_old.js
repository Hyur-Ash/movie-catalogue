        ...
        {searchedMedias.length > 0 ? <>
          ...
          <div className="medias">
            {searchedMedias.map((media, i) => (
              <MediaCover hideTrash mediaType={lastSearch.mediaType.value} showTitle data={media} key={`media${i}`} href={`/${lastSearch.mediaType.value}/${media.id}`}/>
            ))}
          </div>
        </>:
